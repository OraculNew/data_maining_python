...
class GbBlogParse:
    ...
    def parse_post(self, url, soup):
        ...
        datetime_post = soup.find("time", attrs={"class": "text-md text-muted m-r-md"}).get("datetime")
        ...
        data = {
            ...
            "image": image_href,
            "date": dt.datetime.fromtimestamp(int(time.mktime(time.strptime(datetime_post, "%Y-%m-%dT%X%z")))
                                              + time.timezone),
